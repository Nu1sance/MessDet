...
checkpoint = 'checkpoints/pretrain/recspnext_str_reca/epoch_300.pth'  # noqa

# ========================Frequently modified parameters======================
# -----data related-----
data_root = '../Data/DIOR'
# Path of train annotation folder
train_ann_file = 'ImageSets/Main/train.txt'
train_data_prefix = 'JPEGImages-trainval'  # Prefix of train image path
# Path of val annotation folder
val_ann_file = 'ImageSets/Main/val.txt'
val_data_prefix = 'JPEGImages-trainval'  # Prefix of val image path
# Path of test images folder
test_ann_file = 'ImageSets/Main/test.txt'
test_data_prefix = 'JPEGImages-test'
...
dataset_type = 'YOLOv5DIORDataset'
